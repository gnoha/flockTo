...
flock6 = Flock.create(
  ...
  description: 'I am going to place 5 to go to event 2',
  date: '2015-07-24',
  event_id: 1, parent_id: 5)
...
event = Event.create(title: 'Event 1', date: '2015-08-03',
...
event2 = Event.create(title: 'Event 2', date: '2015-08-02',
...
event3 = Event.create(title: 'Event 3', date: '2015-08-15',
        description: 'Tiramisu bonbon dessert. Marshmallow tart halvah sugar plum macaroon ice cream sweet roll jelly. Oat cake candy canes oat cake brownie lollipop. Pie dragée biscuit.')
